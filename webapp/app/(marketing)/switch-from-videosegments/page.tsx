    ...
    <main style={{ color: 'var(--text)', fontFamily: 'var(--font)' }}>
      ...
      <Section heading={<>What you gain that you didn&apos;t have</>}>
        <p style={PROSE}>
          ...
          <a href="/active-recall-youtube" style={{ color: '#0D9488', fontWeight: 600 }}>active recall</a> and{' '}
          <a href="/spaced-repetition-youtube" style={{ color: '#0D9488', fontWeight: 600 }}>spaced repetition</a>,
