...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    'Sign in to ClipMark to sync your YouTube bookmarks, Active Recall decks, and shared collections across every device.',
  path: '/signin',
  ogTitle: 'Sign in to ClipMark',
  ogSubtitle: 'Sync your bookmarks, Active Recall decks, and shared collections across every device.',
});
