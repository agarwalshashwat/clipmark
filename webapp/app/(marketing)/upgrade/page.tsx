...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    'Compare ClipMark Free and Pro. Free covers unlimited local bookmarks and Active Recall basics; Pro adds cloud sync, unlimited flashcards, and Anki export.',
  path: '/upgrade',
  ogTitle: 'Free & Pro Plans',
  ogSubtitle: 'Unlimited local bookmarks free. Pro adds cloud sync, unlimited flashcards, and Anki export.',
});
