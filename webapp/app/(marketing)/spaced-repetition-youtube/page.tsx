    ...
    <main style={{ color: 'var(--text)', fontFamily: 'var(--font)' }}>
      ...
      <Section tint heading={<>What&apos;s free, and what isn&apos;t</>}>
        <p style={PROSE}>
          ...
          <a href="/upgrade" style={{ color: 'var(--brand-ink)', fontWeight: 600 }}>pricing page</a> marks them as such.
        </p>
        ...
        <p style={{ ...PROSE, marginBottom: 0 }}>
          ...
          <a href="/youtube-to-anki" style={{ color: 'var(--brand-ink)', fontWeight: 600 }}>YouTube to Anki</a>.
        </p>
      </Section>
