...
export default async function Home({
  ...
  return (
    <main style={{ background: 'var(--bg)', color: 'var(--text)', fontFamily: "var(--font)", minHeight: '100vh', overflowX: 'hidden' }}>
      <script
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '100px 32px 0', position: 'relative', zIndex: 1, textAlign: 'center' }}>
          ...
          <div style={{ marginTop: 120, position: 'relative', maxWidth: 1080, margin: '120px auto 0' }}>
            ...
            <div style={{
              ...
              <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--text)' }}>AI auto-magically summarizes architecture</span>
            </div>
