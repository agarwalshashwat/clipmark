  ...
  return (
    <nav style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: 1240, margin: '0 auto', padding: '0 24px', height: 80 }}>
        <a href="/" style={{ fontSize: 24, fontWeight: 800, color: '#0f172a', letterSpacing: '-1px', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <div className="nav-links" style={{ display: 'flex', alignItems: 'center', gap: 32 }}>
          <a href="/#features" style={{ color: '#475569', fontWeight: 600, fontSize: 13, textDecoration: 'none', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Features</a>
          <a href="/upgrade" style={{ color: '#475569', fontWeight: 600, fontSize: 13, textDecoration: 'none', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Pricing</a>
          <a href="/affiliate" style={{ color: '#475569', fontWeight: 600, fontSize: 13, textDecoration: 'none', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Join Affiliate</a>
        </div>
